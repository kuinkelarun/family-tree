...
export default function AdminPanel({ onClose, page = false }) {
  ...
  const containerStyle = page
    ? { position: 'fixed', left: 0, top: 0, right: 0, bottom: 0, background: '#fff', borderRadius: 0, boxShadow: 'none', zIndex: 1200, padding: 20, overflow: 'auto' }
    : { position: 'fixed', left: 60, top: 60, right: 60, bottom: 60, background: '#fff', borderRadius: 10, boxShadow: '0 12px 28px rgba(0,0,0,0.18)', zIndex: 1200, padding: 12, overflow: 'auto' };
  return (
    <div>
